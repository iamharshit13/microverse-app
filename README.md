...
**microverse** is a cloud-native microservices recommendation platform built with Django, FastAPI, Kafka, Redis, Docker, and Kubernetes-oriented project structure. The project now includes an AI recommendation layer that uses event-driven user signals, Redis-backed feature storage, vector-style item ranking, and feedback-based personalization.
...
- **Infrastructure**
  - Docker Compose for Kafka, Zookeeper, Redis, Django, and FastAPI.
